...
export default function GanttChart({ orgId, projectId, projectName: projectNameProp, orgName }: GanttChartProps) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-background border border-border-default rounded-xl overflow-hidden shadow-sm [--gantt-sidebar-width:140px] sm:[--gantt-sidebar-width:240px]">
      {/* ── Toolbar ──────────────────────────────────────────────────────────── */}
